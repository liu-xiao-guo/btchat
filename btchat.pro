...
UBUNTU_TRANSLATION_DOMAIN="btchat.liu-xiao-guo"
...
aptest.commands = bash $$PWD/btchat/tests/autopilot/run
aptest.depends  = sub-btchat

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/btchat/tests/unit
unittest.depends  = sub-btchat
